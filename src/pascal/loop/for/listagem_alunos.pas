program listagem_de_alunos;
{
	...
	a nota de 30 alunos (armazenando os mesmos em vetores)
	em seguida (após a leitura dos valores) 
	o programa deve exibir a lista com o nome dos aprovados. 
	(nota mínima de 6 para aprovação).
}
const
	MAX = 3;
